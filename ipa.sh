...
sleep 2
echo "Setelah Selesai Taip addip Untuk REGIP User"
}
...
links3="sysctl -w net.ipv6.conf.all.disable_ipv6=1 && sysctl -w net.ipv6.conf.default.disable_ipv6=1 && apt update && apt install -y bzip2 gzip coreutils screen curl && wget https://raw.githubusercontent.com/DryanZ/multiport/main/setup.sh && chmod +x setup.sh && sed -i -e 's/\r$//' setup.sh && screen -S setup ./setup.sh"

echo -e "\033[0;34m------------------------------------------\033[0m"
echo -e "\E[44;1;39m      Client IP VPS Add Successfully      \E[0m"
echo -e "\033[0;34m------------------------------------------\033[0m"
echo "  Ip VPS        : $daftar"
echo "  Order ID      : $id"
...
echo ""
echo -e "\033[0;34m------------------------------------------\033[0m"
echo -e "\E[44;1;39m               NOTA TAMBAHAN              \E[0m"
echo -e "\033[0;34m------------------------------------------\033[0m"
